# PR #172:  SPEAR/SABLE Weapons Update

- **Author:** AMcilraith
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/172
...
```
:cl:
add: Added new SPEAR/SABLE weapons for use in combat.  
tweak: Adjusted existing weapon stats for improved balance.  
fix: Resolved issues with weapon icons not displaying correctly.  
balance: Tweaked ammo types for new weapons to enhance gameplay variety.  
soundadd: Introduced new sound effects for evacuation announcements.  
config: Added new configuration options for BYOND version restrictions.
/:cl:
```
...
- `code/__DEFINES/projectile_defines.dm` (+2 / -0) modified
...
- `code/game/objects/items/weapons/storage/deferred.dm` (+1 / -1) modified
...
- `code/modules/projectiles/ammunition/bullets.dm` (+33 / -8) modified
- `code/modules/projectiles/guns/launcher/rocket.dm` (+296 / -3) modified
- `code/modules/projectiles/projectile/special.dm` (+15 / -43) modified
...
- `icons/obj/guns/projectile/sable.dmi` (+0 / -0) added
- `icons/obj/guns/projectile/spear.dmi` (+0 / -0) added
...
- `maps/Centcom/map/centcom.dmm` (+0 / -24) modified
- `maps/_DeepForest/map/_Greyson_Field_Office.dmm` (+0 / -1) modified
- `maps/__Nadezhda/area/_Nadezhda_areas.dm` (+12 / -0) modified
- `maps/__Nadezhda/map/_Nadezhda_Colony.dmm` (+2464 / -1074) modified
...
index 54138c050c8..454136e4843 100644
...
index 4c04f403883..8e2c939ec39 100644
...
index a4e7dc1f12f..55422f6a826 100644
...
index 1cea5652cb1..3fae0cb6f14 100644
...
index 4b9911d61ef..b44b44c0799 100755
...
index ce8d0108d0c..b881cfe283f 100755
...
new file mode 100644
index 00000000000..5433ad3dd43
Binary files /dev/null and b/icons/obj/guns/projectile/sable.dmi differ
diff --git a/icons/obj/guns/projectile/spear.dmi b/icons/obj/guns/projectile/spear.dmi
new file mode 100644
index 00000000000..35444a7e290
Binary files /dev/null and b/icons/obj/guns/projectile/spear.dmi differ
...
index 004a1715a4b..c9bc44142d3 100755
...
index 315485bfb0c..93243098bba 100644
...
index da64c3d035e..f7e774fdb71 100644
...
index 1d4049c7c2c..5d334239a8f 100644
...
@@ -2945,6 +2948,7 @@
 ...
 #include "code\modules\projectiles\guns\launcher\projectile_grenade_launcher.dm"
+#include "code\modules\projectiles\guns\launcher\rocket.dm"
 #include "code\modules\projectiles\guns\launcher\syringe_gun.dm"
 #include "code\modules\projectiles\guns\matter\launcher.dm"
 #include "code\modules\projectiles\guns\matter\launcher\books.dm"
