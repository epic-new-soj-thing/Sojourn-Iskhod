# PR #321: New Map Major Testmerge

- **Authors:** addi-4th, MsRandylicious, Yeen, AMcilraith, Bamzahalam
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/321
...
add: Advanced defibrillator and jumper cable kit.
...
tweak: Science point yields and calculation; xenoarch adjustments.
tweak: TGUI, minimap, and skin updates; restart and update notification behaviour.
...
fix: Defibrillator behaviour and missing sprites (anomaly containers, toxins APC).
