...
- **Author:** AMcilraith
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/128
...
Fixes fax machines not having the admin-level factions.
<hr>
</details>
...
```
:cl:
fix: Fixed issues with fax machine authentication and operation.  
fix: Corrected handling of send requests for admin departments.  
fix: Improved error handling for unknown departments in the fax system.
/:cl:
```
...
- `code/modules/paperwork/faxmachine.dm` (+280 / -259) modified
...
index 0777ad2f3af..02e663c9e06 100755
...
@@ -295,6 +181,141 @@ var/last_staff_request_time = 0
 	if(ping_id)
