# PR #290: bot that does changelogs

- **Author:** AMcilraith
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/290
...
```
:cl:
add: Introduced automated changelog generation workflow using GitHub Copilot.  
add: Added manual changelog comparison workflow for more controlled diff checks.
/:cl:
```
...
- `.github/workflows/copilot-compare-changelogs.yml` (+139 / -0) added
- `.github/workflows/manual-compare-changelogs.yml` (+114 / -0) added
- `tools/generate_changelog.py` (+412 / -0) added
...
index 00000000000..4ed45c3e4f4
--- /dev/null
+++ b/.github/workflows/copilot-compare-changelogs.yml
@@ -0,0 +1,139 @@
...
+            - Prefer concise, player-facing descriptions. Group noisy low-level changes.
...
new file mode 100644
index 00000000000..b45a90f3fa2
--- /dev/null
+++ b/.github/workflows/manual-compare-changelogs.yml
@@ -0,0 +1,114 @@
