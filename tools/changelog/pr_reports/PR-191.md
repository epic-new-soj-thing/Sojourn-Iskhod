# PR #191: SI Helmet Changes

- **Author:** AMcilraith
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/191
...
```
:cl:
tweak: SI helmets now have enhanced protection features.  
tweak: Certain perks now include copiable protections, preventing easy exploitation.  
balance: Adjusted cooldown periods for various perks to improve gameplay pacing.  
add: New perks added to enhance gameplay variety and player customization options.
/:cl:
```
...
- `code/modules/clothing/head/helmet.dm` (+208 / -4) modified
- `code/modules/clothing/head/tracking_arrow.dm` (+8 / -0) added
...
- `code/modules/modular_computers/file_system/programs/medical/suit_sensors.dm` (+24 / -3) modified
...
index 38494481bb7..93ab7b4069a 100644
...
index 6750d5c19ea..52e8b835ea5 100644
...
index 00000000000..7cdb3e606bb
--- /dev/null
+++ b/code/modules/clothing/head/tracking_arrow.dm
@@ -0,0 +1,8 @@
+//Tracking arrow screen overlay
+/obj/screen/tracking_arrow
+	name = "tracking arrow"
...
index 5654b162b4c..fbc23926693 100644
...
index 2a0a8a725e7..b8a317391df 100644
...
index 5d334239a8f..42ab3603372 100644
...
+#include "code\modules\clothing\head\tracking_arrow.dm"
 #include "code\modules\clothing\masks\balaclava.dm"
 #include "code\modules\clothing\masks\breath.dm"
 #include "code\modules\clothing\masks\costume.dm"
