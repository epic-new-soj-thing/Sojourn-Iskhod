# PR #192: re-implements borer code

- **Author:** AMcilraith
- **Link:** https://github.com/epic-new-soj-thing/Sojourn-Iskhod/pull/192
...
```
:cl:
add: Re-implemented borer code, affecting player interactions with the borer gameplay mechanics.
/:cl:
```
