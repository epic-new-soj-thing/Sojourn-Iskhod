#define SCRUBBER_SCRUB 1
#define SCRUBBER_SIPHON 2
#define SCRUBBER_EXCHANGE 3
...
/obj/machinery/atmospherics/unary/vent_scrubber/proc/broadcast_status()
	...
	signal.data = list(
		...
		"filter_plasma" = (MATERIAL_PLASMA in scrubbing_gas),
...
/obj/machinery/atmospherics/unary/vent_scrubber/receive_signal(datum/signal/signal)
	...
	if(!isnull(signal.data["tox_scrub"]) && text2num(signal.data["tox_scrub"]) != (MATERIAL_PLASMA in scrubbing_gas))
		toggle += MATERIAL_PLASMA
