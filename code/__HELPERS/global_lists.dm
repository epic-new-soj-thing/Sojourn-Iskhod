...
GLOBAL_VAR_INIT(ert_authorized, FALSE)
...
DEPARTMENT_SECURITY, DEPARTMENT_SECURITY, DEPARTMENT_SERVICE, DEPARTMENT_CHURCH, DEPARTMENT_CIVILIAN, DEPARTMENT_PROSPECTOR)
