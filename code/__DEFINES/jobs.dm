...
#define JOBS_SUPPLY "Operations Manager","Cargo Technician","Mining Technician"
...
#define SALVAGER_NAME "Salvager"
#define PROSPECTOR_NAME "Prospector"
#define ROOKIE_PROSPECTOR "Rookie"
#define CREDS "&cent;"
...
#define DEPARTMENT_CHURCH	"Order of the Word"
