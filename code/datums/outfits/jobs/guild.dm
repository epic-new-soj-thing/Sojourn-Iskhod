...
/decl/hierarchy/outfit/job/cargo/merchant
	name = OUTFIT_JOB_NAME("Frontier Logistics - Operations Manager")
...
/decl/hierarchy/outfit/job/cargo/cargo_tech
	name = OUTFIT_JOB_NAME("Frontier Logistics - Technician")
...
/decl/hierarchy/outfit/job/cargo/mining
	name = OUTFIT_JOB_NAME("Frontier Logistics - Miner")
...
/decl/hierarchy/outfit/job/cargo/mining/void
	name = OUTFIT_JOB_NAME("Frontier Logistics - Miner Voidsuit")
