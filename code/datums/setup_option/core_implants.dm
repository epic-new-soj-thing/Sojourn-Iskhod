/datum/category_item/setup_option/core_implant/cruciform
	...
	desc = "The implant given to every member of the Naturalists. This one is a standard Vinculum design, having the base-line of a normal cruciform."
...
/datum/category_item/setup_option/core_implant/cruciform/tessellate
	...
	desc = "The implant given to every member of the Naturalists. This one is made for those who walk the path of the Tessellate—promoting unity and healing. It charges slightly faster \
...
/datum/category_item/setup_option/core_implant/cruciform/lemniscate
	...
	desc = "The implant given to every member of the Naturalists. This one is made for those who walk the path of the Lemniscate—change is circular in nature; only through teamwork can people prosper. \
...
/datum/category_item/setup_option/core_implant/cruciform/monomial
	...
	desc = "The implant given to every member of the Naturalists. This one is made for those who walk the path of the Monomial—personal improvement and aesthetic living. \
...
/datum/category_item/setup_option/core_implant/cruciform/divisor
	...
	desc = "The implant given to every member of the Naturalists. This one is made for those who walk the path of the Divisor—the sect has no enforcement wing, but some Hands still take up arms to protect the flock when the bunker is threatened."
...
/datum/category_item/setup_option/core_implant/cruciform/factorial
	...
	desc = "The implant given to every member of the Naturalists. This one is made for those who walk the path of the Factorial—tending the sect's machines and technology so that life in the bunker may be maintained. \
