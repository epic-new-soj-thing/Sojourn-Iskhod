...
/datum/cooking/recipe_step/add_item/New(var/item_type, var/datum/cooking/recipe/our_recipe)
...
/datum/cooking/recipe_step/add_item/check_conditions_met(var/obj/added_item, var/datum/cooking/recipe_tracker/tracker)
	#ifdef COOKING_DEBUG
...
/datum/cooking/recipe_step/add_item/calculate_quality(var/obj/added_item, var/datum/cooking/recipe_tracker/tracker)
	var/raw_quality = added_item?:food_quality * inherited_quality_modifier
	return clamp_quality(raw_quality)

/datum/cooking/recipe_step/add_item/follow_step(var/obj/added_item, var/datum/cooking/recipe_tracker/tracker)
	#ifdef COOKING_DEBUG
