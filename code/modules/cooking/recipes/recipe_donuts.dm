/datum/cooking/recipe/medialuna //This is 100% a donut but with extra layers
	...
	step_builder = list(
		...
		list(COOKING_ADD_REAGENT_OPTIONAL, "cream", 1, base=1, add_price = 1),
...
/datum/cooking/recipe/donut
	...
	step_builder = list(
		...
		list(COOKING_ADD_REAGENT, "sugar", 5),
		list(COOKING_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5, add_price = 5),
		list(COOKING_ADD_REAGENT_OPTIONAL, "glaze", 5, base=1, add_price = 2),
...
/datum/cooking/recipe/jellydonut
	...
	step_builder = list(
		list(COOKING_ADD_ITEM, /obj/item/reagent_containers/snacks/doughslice, qmod=0.5),
		list(COOKING_ADD_REAGENT, "cornoil", 1),
		list(COOKING_ADD_REAGENT, "berryjuice", 5),
		list(COOKING_ADD_REAGENT, "sugar", 5),
		list(COOKING_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5, add_price = 5),
		list(COOKING_ADD_REAGENT_OPTIONAL, "glaze", 5, base=1, add_price = 2),
		list(COOKING_USE_OVEN, J_LO, 20 SECONDS)
...
/datum/cooking/recipe/cinnamonroll
	...
	step_builder = list(
		list(COOKING_ADD_ITEM, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5),
		list(COOKING_ADD_ITEM, /obj/item/reagent_containers/snacks/doughslice, qmod=0.5),
		list(COOKING_ADD_REAGENT, "cinnamonpowder", 5),
		list(COOKING_ADD_REAGENT, "sugar", 10),
		list(COOKING_ADD_REAGENT, "milk", 5),
		list(COOKING_ADD_REAGENT, "egg", 3),
		list(COOKING_USE_ITEM_OPTIONAL, /obj/item/material/kitchen/rollingpin, add_price = 3),
		list(COOKING_ADD_REAGENT_OPTIONAL, "glaze", 5, base=1, add_price = 2),
		list(COOKING_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5, add_price = 5),
		list(COOKING_USE_OVEN, J_LO, 20 SECONDS)
	)
...
/datum/cooking/recipe/chaosdonut
	...
	step_builder = list(
		...
		list(COOKING_USE_ITEM_OPTIONAL, /obj/item/material/kitchen/rollingpin, add_price = 3),
		list(COOKING_ADD_REAGENT, "capsaicin", 5),
		list(COOKING_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5, add_price = 5),
		list(COOKING_ADD_REAGENT, "sugar", 5),
		list(COOKING_ADD_REAGENT_OPTIONAL, "glaze", 5, base=1, add_price = 2),
		list(COOKING_USE_OVEN, J_LO, 20 SECONDS)
...
/datum/cooking/recipe/poppypretzel
	...
	step_builder = list(
		list(COOKING_ADD_ITEM, /obj/item/reagent_containers/snacks/doughslice, qmod=0.5),
		list(COOKING_USE_ITEM_OPTIONAL, /obj/item/material/kitchen/rollingpin, add_price = 3),
		list(COOKING_ADD_REAGENT, "sodiumchloride", 3, base=1),
		list(COOKING_ADD_ITEM_OPTIONAL, /obj/item/reagent_containers/snacks/butterslice, qmod=0.5, add_price = 5),
		list(COOKING_ADD_PRODUCE, "poppy", reagent_skip=TRUE),
