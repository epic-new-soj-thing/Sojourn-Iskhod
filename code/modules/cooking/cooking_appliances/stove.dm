...
/obj/machinery/cooking/stove/New()
	..()
	bsmoke.attach(src)
...
/obj/machinery/cooking/stove/proc/handle_burning(input)
	if(!(items[input] && istype(items[input], /obj/item/reagent_containers/cooking/container)))
		return

	var/obj/item/reagent_containers/cooking/container/container = items[input]
...
/obj/machinery/cooking/stove/proc/emit_fire()
	bsmoke.start()
...
/obj/machinery/cooking/stove/proc/getInput(params)
	...
	#ifdef COOKING_DEBUG
	log_debug("cooking/stove/proc/getInput returned burner [input]. icon-x: [click_params["icon-x"]], icon-y: [click_params["icon-y"]]")
	#endif
	return input

/obj/machinery/cooking/stove/attackby(var/obj/item/used_item, var/mob/user, params)
...
/obj/machinery/cooking/stove/CtrlClick(var/mob/user, params)
...
/obj/machinery/cooking/stove/CtrlShiftClick(var/mob/user, params)
...
/obj/machinery/cooking/stove/proc/timer_act(var/mob/user, var/input)
