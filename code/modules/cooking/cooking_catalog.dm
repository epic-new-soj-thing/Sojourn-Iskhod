/datum/computer_file/program/cook_catalog
	...
	filedesc = "VIKA"
	extended_desc = "Frontier Logistics (and Vesalius-Andra) Presents: Very Incredible Kitchen Assistant - an AI-generated electronic catalog for cooking."
...
/proc/createCookingCatalogs()
	for(var/datum/cooking/recipe/our_recipe in GLOB.cooking_recipe_list)
