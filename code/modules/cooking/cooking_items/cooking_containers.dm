...
/obj/item/reagent_containers/cooking/container
	...
	var/list/deepfry_data = list("High"=0 , "Medium" = 0, "Low"=0) //Record of what deep-frying has been done on this food.

/obj/item/reagent_containers/cooking/container/Initialize()
	.=..()
	appearance_flags |= KEEP_TOGETHER


/obj/item/reagent_containers/cooking/container/examine(var/mob/user)
	if(!..(user, 1))
		return FALSE
	if(contents)
...
/obj/item/reagent_containers/cooking/container/proc/get_content_info()
	var/string = "It contains:</br><ul><li>"
	string += jointext(contents, "</li><li>") + "</li></ul>"
	return string

/obj/item/reagent_containers/cooking/container/proc/get_reagent_info()
	return "It contains [reagents.total_volume] units of reagents."

/obj/item/reagent_containers/cooking/container/attackby(var/obj/item/used_item, var/mob/user)
...
/obj/item/reagent_containers/cooking/container/standard_pour_into(mob/user, atom/target)
...
/obj/item/reagent_containers/cooking/container/afterattack(var/obj/target, var/mob/user, var/flag)
...
/obj/item/reagent_containers/cooking/container/proc/process_item(var/obj/I, var/mob/user, var/lower_quality_on_fail = 0, var/send_message = TRUE)
...
/obj/item/reagent_containers/cooking/container/proc/handle_burning()
	clear()
...
/obj/item/reagent_containers/cooking/container/proc/clear()
	QDEL_LIST(contents)
	contents=list()
...
/obj/item/reagent_containers/cooking/container/verb/empty()
	set src in view(1)
...
/obj/item/reagent_containers/cooking/container/proc/do_empty(mob/user, var/atom/target = null, var/reagent_clear = TRUE)
	#ifdef COOKING_DEBUG
...
/obj/item/reagent_containers/cooking/container/AltClick(var/mob/user)
	do_empty(user)


/obj/item/reagent_containers/cooking/container/proc/clear_cooking_data()
	stove_data = list("High"=0 , "Medium" = 0, "Low"=0)
	grill_data = list("High"=0 , "Medium" = 0, "Low"=0)
	oven_data = list("High"=0 , "Medium" = 0, "Low"=0)
	deepfry_data = list("High"=0 , "Medium" = 0, "Low"=0)

/obj/item/reagent_containers/cooking/container/proc/label(var/number, var/CT = null)
...
/obj/item/reagent_containers/cooking/container/update_icon()
	cut_overlays()
...
/obj/item/reagent_containers/cooking/container/proc/add_to_visible(var/obj/item/our_item)
...
/obj/item/reagent_containers/cooking/container/proc/remove_from_visible(var/obj/item/our_item)
	our_item.vis_flags = 0
	our_item.blend_mode = 0
	our_item.transform = null
	src.vis_contents.Remove(our_item)

/obj/item/reagent_containers/cooking/container/plate
...
/obj/item/reagent_containers/cooking/container/board
	name = "cutting board"
...
/obj/item/reagent_containers/cooking/container/oven
	name = "oven dish"
	shortname = "shelf"
...
/obj/item/reagent_containers/cooking/container/pan
	name = "pan"
	desc = "An normal pan."
...
/obj/item/reagent_containers/cooking/container/pot
	name = "cooking pot"
	shortname = "pot"
...
/obj/item/reagent_containers/cooking/container/deep_basket
...
/obj/item/reagent_containers/cooking/container/air_basket
...
/obj/item/reagent_containers/cooking/container/grill_grate
	name = "grill grate"
	shortname = "grate"
	place_verb = "onto"
...
/obj/item/reagent_containers/cooking/container/bowl
	name = "prep bowl"
	shortname = "bowl"
