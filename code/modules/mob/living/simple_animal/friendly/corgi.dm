...
/mob/living/simple/corgi/New()
	..()
	nutrition = max_nutrition * 0.3//Ian doesn't start with a full belly so will be hungry at roundstart

/mob/living/simple/corgi/fluff // Refactoring pets here for the sake of AI
	var/mob/living/carbon/human/friend
	var/befriend_job = null

//IAN! SQUEEEEEEEEE~
/mob/living/simple/corgi/fluff/Ian
	name = "Ian"
...
/mob/living/simple/corgi/fluff/Life()
	..()
	if(friend)
		health_of_friend_checks()

/mob/living/simple/corgi/fluff/proc/health_of_friend_checks()
...
/mob/living/simple/corgi/fluff/verb/friend()
...
/mob/living/simple/corgi/beg(var/atom/thing, var/atom/holder)
...
/mob/living/simple/corgi/attackby(var/obj/item/O as obj, var/mob/user as mob)  //Marker -Agouri
...
/mob/living/simple/corgi/puppy/beg(var/atom/thing, var/atom/holder)
	visible_emote("stares at \the [thing] that [holder] has with sad puppy eyes.")
	playsound(loc, 'sound/effects/creatures/puppy_beg.ogg', 50, 1)

//LISA! SQUEEEEEEEEE~
/mob/living/simple/corgi/fluff/Lisa
	name = "Lisa"
	real_name = "Lisa"
	gender = FEMALE
...
/mob/living/simple/corgi/fluff/Lisa/Topic(href, href_list)
	if(href_list["remove_inv"] || href_list["add_inv"])
		to_chat(usr, "\red [src] already has a cute bow!")
		return
	..()

/mob/living/simple/corgi/fluff/Lisa/Life()
	..()
	...
	if(!stat && !resting && !buckled)
		...
		if(turns_since_scan > 15)
			...
			for(var/mob/M in oviewers(7, src))
				if(istype(M, /mob/living/simple/corgi/fluff/Ian))
					if(M.client)
						alone = 0
						break
					else
...
/mob/living/simple/corgi/E_N/death()
	..()
...
/mob/living/simple/corgi/E_N/attackby(obj/item/W as obj, mob/user as mob)
