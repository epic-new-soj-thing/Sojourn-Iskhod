...
/datum/gear/factionsoteria/cloakmbo
	...
	allowed_roles = list("Biolab Overseer")
	slot = slot_wear_suit
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/si_bdu
	...
	allowed_roles = list("Doctor","Biolab Overseer","Paramedic", "Resident")
	slot = slot_wear_suit
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/gorkamoebiusmedical
	...
	allowed_roles = list("Doctor","Biolab Overseer","Paramedic")
	slot = slot_w_uniform
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/medicalscouter
	...
	allowed_roles = list("Biolab Overseer","Doctor","Paramedic","Corpsman", "Resident")
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/scrubs
	...
	allowed_roles = list("Psychiatrist","Paramedic","Doctor","Biolab Overseer", "Resident")
	slot = slot_w_uniform
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/snowsuitmedical
	...
	allowed_roles = list("Psychiatrist","Nurse","Paramedic","Biolab Overseer", "Resident")
	slot = slot_wear_suit
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/winterbootsmedical
	...
	allowed_roles = list("Psychiatrist","Paramedic","Doctor","Biolab Overseer")
	slot = slot_shoes
	sort_category = "Faction: Vesalius-Andra"
...
/datum/gear/factionsoteria/penlight
	...
	allowed_roles = list("Paramedic","Doctor","Biolab Overseer", "Resident")
	slot = slot_r_ear
	sort_category = "Faction: Vesalius-Andra"
	cost = 0
