...
/obj/item/book/manual/demonomicon
	...
	dat = {"<html>
				...
				<tr><td class="spell">Condense.</td><td class="candles">5</td><td class="candles">40</td><td>Turn a shard on the rune into a soulstone; requires both Cult and Occult and a path (Scribe, Binder, or Alchemist).</td></tr>
				<tr><td class="spell">Form.</td><td class="candles">5</td><td class="candles">35</td><td>Turn sandstone on the rune into a soulstone; requires a path (Scribe, Binder, or Alchemist).</td></tr>
				...
				<tr><td class="spell">Satchel.</td><td class="candles">5</td><td class="candles">25</td><td>Alchemist only: turn a blood pouch on the rune into an alchemy satchel.</td></tr>
				...
				<h3>Soulstones</h3>
				<p><b>Soulstones</b> are dark crystalline shards that resonate with blood and ritual. They can be carried in a slot (pocket or hand). When <b>dormant</b>, the base soulstone still steadies the mind slightly when carried; when <b>energized</b> (see below), a soulstone takes on a brighter aspect and grants tier-specific abilities.</p>
				<h4>Creation (endgame)</h4>
				<p>Soulstones are endgame foci; each tier is <b>progressively much harder</b> to obtain, but still achievable with preparation.</p>
				<p><b>Base soulstone:</b> Three ways. You must have chosen a <b>path</b>&mdash;Scribe, Binder (Tome Binder), or Alchemist&mdash;to create one by ritual; xenoarchaeology has no such requirement. (1) <b>Xenoarchaeology:</b> Soulstones rarely appear in digs at <b>temple</b> or <b>war</b> sites where the nitrogen tracer responds (crystalline structures, soul stones, crystal shards). Excavate the strange rock and reveal the find&mdash;the roll is unforgiving. (2) <b>Condense.</b> (book spell): You must know <b>both</b> the Cult and the Occult tongue (Babel. and Voice.) and have a path. Place a <b>crystal or plasma shard</b> on the blood rune. Inscribe <i>Condense.</i> on paper (Cult), place the paper within three tiles of the rune, and invoke with a book or the Demonomicon: <b>5 candles, 40 blood</b>. The shard is consumed and a soulstone appears. (3) <b>Form.</b> (book spell): Place <b>sandstone</b> on the blood rune. Inscribe <i>Form.</i> on paper (Cult), place the paper within three tiles of the rune, and invoke with a book or the Demonomicon: <b>5 candles, 35 blood</b>. One unit of sandstone and blood are consumed; a soulstone appears.</p>
				<p><b>Purified soulstone:</b> Place a <b>soulstone</b> on the rune. Inscribe <i>Purify.</i> (Cult or Occult), then invoke with the ritual knife or the Demonomicon: <b>6 candles, 55 blood</b>. Heavy toll on body and mind; the soulstone is replaced by a purified soulstone.</p>
				<p><b>Mystic soulstone:</b> The pinnacle. Place a <b>purified soulstone</b> on the rune. Inscribe <i>Mystic.</i> (Cult or Occult), then invoke with the ritual knife or the Demonomicon: <b>8 candles, 75 blood</b>. The ritual is punishing; the purified soulstone is replaced by a mystic soulstone.</p>
				<h4>Types</h4>
				<ul>
				<li><b>Soulstone</b> (base): A dark shard that drinks the light. When <b>carried</b> (even dormant), it subtly steadies the mind. When <b>energized</b>, it also lowers the blood and health cost of rune rituals for the bearer (or when placed on the rune).</li>
				<li><b>Purified soulstone:</b> Washed in blood and candle-flame; clearer and holds intent more readily. When energized, it reduces ritual cost further; when energized and <b>carried</b>, it steadies the mind (faster sanity recovery) and <b>failed invocations cost far less blood</b> (only a few measures instead of twelve).</li>
				<li><b>Mystic soulstone:</b> Refined through a second ritual; hums with latent power. When energized, it reduces ritual cost the most and, while carried, stifles psionics and cruciform rites in <b>others</b> nearby&mdash;the bearer is not affected and may still use psionics.</li>
				</ul>
				<h4>Energizing</h4>
				<p>Use the soulstone <b>on the blood rune</b> (click the soulstone on the rune). You need at least <b>one candle</b> within three tiles of the rune and <b>15 blood</b>. The soulstone absorbs blood and candle-light and becomes <b>energized</b>; its appearance shifts to a brighter, glowing form. Energizing is permanent until the stone is lost or destroyed. An already-energized soulstone cannot be energized again.</p>
				<h4>Abilities (when energized)</h4>
				<p>Each tier has <b>distinct</b> effects; they are not the same ability strengthened.</p>
				<ul>
				<li><b>Soulstone (base):</b> When energized and <b>in your inventory or on the rune</b>, <b>blood and health costs of rune rituals are reduced</b> (about 15% less). When carried at any time, it also steadies the mind slightly. No effect on psionics.</li>
				<li><b>Purified soulstone:</b> Ritual cost reduction (about 28% less). When energized and <b>carried in a slot</b>, it <b>steadies the mind</b> (faster sanity recovery) and <b>reduces the blood cost of failed invocations</b> to a few measures instead of twelve. No effect on psionics.</li>
				<li><b>Mystic soulstone:</b> Strongest ritual cost reduction (about 40% less). When energized and carried, it creates a <b>field that stifles psionics and cruciform litanies in others</b> within two tiles&mdash;but <b>not in you</b>; the bearer can still use psionics and is not blocked. Those in the field find their cruciform cold and unresponsive, and their psionic powers inhibited.</li>
				</ul>
				</div>
				...
				<li><b>Alchemy satchel</b>: Obtained by invoking <b>Satchel.</b> at a rune (5 candles, Alchemist only) with a blood pouch on the rune. A belt-worn satchel that holds throwing flasks and alembic phials; it must be opened before use.</li>
				</ul>
				<h3>Recipe Paper</h3>
