...
/obj/item/book/manual/demonomicon
	...
	dat = {"<html>
				...
				<tbody>
				<tr><td>Xenoarchaeology</td><td>Temple or war dig; nitrogen tracer responds (crystalline structures, soul stones). Excavate the strange rock and reveal the find.</td><td class="candles">&#8212;</td><td class="candles">&#8212;</td><td>Base soulstone (rare).</td></tr>
