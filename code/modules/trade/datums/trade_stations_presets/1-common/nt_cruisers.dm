/datum/trade_station/nt_cruisers
	...
	name_pool = list(
		"CAV 'Faith'" = "Order of the Word vessel 'Faith': \"We are currently resupplying from Iskhod, but we can sell a few items from our stock.\"",
		"CAV 'Hope'" = "Order of the Word vessel 'Hope': \"We're in the system for the next few hours before we make a round trip to the confederacy, we're certainly willing to sell our goods.\""
		)
