...
/obj/item/device/lighting/toggleable/lantern/censer
	...
	icon_state = "censer"
	item_state = "censer"
	desc = "A silver-gold incense burner that releases a sweet, comforting perfume. Sometimes used in consecration ceremonies by the Naturalists, where the incense is said to clean and purify the air so the Word may be given more clearly."
