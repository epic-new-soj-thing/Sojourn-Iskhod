...
/obj/item/deck/cah/var/list/card_text_list = list(
	...
	"A Guild Master who can't setup the engine",
	"Being sucked out into space",
	"Officer Beepsky",
	"Engineering",
	"The grey tide.",
	"The Research Overseer",
	"Fucking synths",
	...
	"The throbbing erection that security gets at the thought of shooting something",
	...
	"A cargo technician who WON'T STOP ordering guns",
	"Teaching a synthetic the Birds and the Bees",
	"Unnecessary surgery",
	"My addiction to spiders",
	"wetmar'qua.nt",
	"DOCTOR MAXMAN!",
	"A group of Mar'qua getting their squish on",
