...
/obj/item/organ/external/robotic/church
	name = "\"Absolute\""
	desc = "Gold and black prosthetics of pre-Exodus design, still used by some members of the Order of the Word despite the sect's preference for simpler tools."
