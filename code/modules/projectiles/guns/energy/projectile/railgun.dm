...
/obj/item/gun/energy/laser/railgun/pistol
	...
	serial_type = "AG"
	init_firemodes = list(
		list(mode_name="slug", mode_desc="fires a small metal chunk at light speeds", projectile_type=/obj/item/projectile/bullet/kurtz_12/railgun, icon="kill"),
		list(mode_name="Less-lethal", mode_desc="fires a small rubber chunk at light speeds. Still likely to ruin someones day.", projectile_type=/obj/item/projectile/bullet/kurtz_12/rubber/railgun, icon="stun"),
