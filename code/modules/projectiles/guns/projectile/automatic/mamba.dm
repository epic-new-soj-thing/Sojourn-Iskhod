...
/obj/item/gun/projectile/automatic/mamba
	name = "\"Mamba\" carbine"
	desc = "Cheaply produced, versatile and made for mass usage are all traits of the .257 \"Mamba\" carbine. Made by Iskhod Ranger gunsmiths to be used in both close and mid-range combat the Mamba sports an adjustable folding-stock and a holographic sight."
	icon_state = "mamba"
	item_state = "mamba"
...
/obj/item/gun/projectile/automatic/mamba/viper
	...
	desc = "The \"Viper\" designated marksman rifle appears to be a design based off the Iskhod Ranger's \"Mamba\" carbine. \
...
/obj/item/gun/projectile/automatic/mamba/copperhead
	...
	desc = "The \"Copperhead\" rifle appears to be a design based off the Iskhod Ranger's \"Mamba\" carbine. \
...
/obj/item/gun/projectile/automatic/mamba/python
	...
	desc = "A fine work of the Iskhod Ranger gunsmiths is the Python, a heavy rifle with a state of the art smart scope displaying wind speeds, built in range finding, nightvision capability and an internal stabilization system. \
