...
/datum/chemical_reaction
	...
	var/list/blacklist_containers = list(/obj/machinery/microwave, /obj/item/reagent_containers/cooking) // This reaction will not occure in these containers(Or their subtypes).
