/datum/job/chaplain
	...
	description = "The Cardinal serves as the head of the local branch of the Church of the Absolute. <br>\
...
/datum/job/acolyte
	...
	description = "The Priest serves the Cardinal, and more generally the church, as a disciple of the Faith.<br>\
