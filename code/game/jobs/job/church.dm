/datum/job/penitent
	...
	description = "The Penitent is the highest rank in the Order of the Word at Iskhod. You serve as the Mouth—the chief giver of the Word—and lead this sect of pilgrims who turned from the shattered Absolute to tend life in the bunker.<br>\
	Two precepts guide you: care for the other, and maintain the life of the world. Where the Order makes its home, life flourishes; the hungry are fed and wounds are tended with meager supplies.<br>\
	...
	The Order of the Word has no enforcement wing, but its members are not sworn to pacifism. When the hivemind threatens the bunker, some take up arms to protect the flock; your ritual book may aid in that defense."
...
/datum/job/mouth
	...
	description = "You are the Mouth—the chief giver of the Word in the Order of the Word. Where the Penitent holds the highest rank and leads the sect, you are the one who speaks the precepts: care for the other, and maintain the life of the world.<br>\
	...
	The Order has no enforcement wing but its members are not sworn to pacifism; when the bunker is threatened, you may take up arms with the rest. Your ritual book allows you to lead the flock in shared litanies."
...
/datum/job/hand
	...
	description = "You are a Hand—a lay member of the Order of the Word. After the fall of Nadezhda and the exodus, this sect walked away from the Absolute to become gardeners who tend the struggling life inside the arctic bunker.<br>\
	...
	The Penitent leads the sect and gives the Word; you support that work and represent the Order in a positive light to all colonists."
