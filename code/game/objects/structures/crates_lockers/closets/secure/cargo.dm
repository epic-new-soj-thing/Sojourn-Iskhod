...
/obj/structure/closet/secure_closet/reinforced/quartermaster/populate_contents()
	...
	new /obj/item/ammo_magazine/ammobox/pistol_9mm(src)
	new /obj/item/ammo_magazine/speed_loader_pistol_9mm(src)
	new /obj/item/ammo_magazine/ammobox/pistol_9mm/rubber(src)
	new /obj/item/ammo_magazine/speed_loader_pistol_9mm/rubber(src)
...
/obj/structure/closet/secure_closet/reinforced/foreman/populate_contents()
	...
	new /obj/item/ammo_magazine/kurtz_12(src)
	new /obj/item/ammo_magazine/kurtz_12(src)
	new /obj/item/ammo_magazine/ammobox/kurtz_12/hv(src)
	//melee
...
/obj/structure/closet/secure_closet/reinforced/foreman/fence/populate_contents()
	...
	new /obj/item/ammo_magazine/smg_10mm(src)
	new /obj/item/ammo_magazine/smg_10mm(src)
	new /obj/item/ammo_magazine/smg_10mm/lethal(src)
	new /obj/item/gun/projectile/automatic/slaught_o_matic(src)
	new /obj/item/gun/projectile/ladon/sa(src)
	new /obj/item/ammo_magazine/pistol_10mm(src)
	new /obj/item/ammo_magazine/pistol_10mm(src)
