...
/obj/item/pc_part/drive/disk/design/nt/basic_utility
	disk_name = "Naturalist Bioprinter Utilities Factory"
	desc = "This disk is sole property of the Naturalists; the files within are encrypted and should not be used, taken, or tested by anyone not affiliated with the sect."
...
/obj/item/pc_part/drive/disk/design/nt/basic_utility/public
	disk_name = "Naturalist Bioprinter Products and Utilities"
	desc = "This disk is made by the Naturalists and distributed at a nominal cost to anyone who wishes to use a bioprinter for basic needs."
	license = 20
	designs = list(
		// Products
		/datum/design/bioprinter/meat,
