...
/obj/item/device/encryptionkey/headset_bs/corps
	...
	channels = list("Security" = 1, "Security(I)" = 1, "Medical(I)" = 1)
...
/obj/item/device/encryptionkey/heads/hos
	...
	channels = list("Command" = 1, "Security(I)" = 1, "Security" = 1)
...
/obj/item/device/encryptionkey/headset_cargo
	name = "frontier logistics radio encryption key"
	icon_state = "cargo_cypherkey"
	channels = list("Supply" = 1, "Service" = 1)

/obj/item/device/encryptionkey/headset_service
	name = "frontier logistics service radio encryption key"
