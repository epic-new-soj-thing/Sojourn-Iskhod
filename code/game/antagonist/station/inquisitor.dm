...
/datum/antagonist/inquisitor/greet()
	...
	to_chat(player, "The Naturalists have no enforcement wing, but they are not sworn to pacifism.<br>\
	...
	<br>\
	Other Naturalists may aid you; Wardens often announce their presence to coordinate. Your goal is to end the hivemind threat; \
