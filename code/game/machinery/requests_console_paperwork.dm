...
/proc/req_console_paperwork_to_pencode(template_text)
	...
	// Build bracket chars at runtime so the compiler never parses [ ] in string args (avoids interpolation/parse errors).
	if(!template_text) return ""
	var/t = template_text
	var/lb = ascii2text(91)
	var/rb = ascii2text(93)
	var/bs = ascii2text(92)
	// Closing tags first (plain tags as stored in template). Replacement = \[/tag\]
	t = replacetext(t, lb + "/table" + rb, bs + lb + "/table" + rb + bs)
	t = replacetext(t, lb + "/list" + rb, bs + lb + "/list" + rb + bs)
	t = replacetext(t, lb + "/large" + rb, bs + lb + "/large" + rb + bs)
	t = replacetext(t, lb + "/center" + rb, bs + lb + "/center" + rb + bs)
	t = replacetext(t, lb + "/h3" + rb, bs + lb + "/h3" + rb + bs)
	t = replacetext(t, lb + "/h2" + rb, bs + lb + "/h2" + rb + bs)
	t = replacetext(t, lb + "/h1" + rb, bs + lb + "/h1" + rb + bs)
	t = replacetext(t, lb + "/small" + rb, bs + lb + "/small" + rb + bs)
	t = replacetext(t, lb + "/b" + rb, bs + lb + "/b" + rb + bs)
	t = replacetext(t, lb + "/i" + rb, bs + lb + "/i" + rb + bs)
	t = replacetext(t, lb + "/u" + rb, bs + lb + "/u" + rb + bs)
	...
	t = replacetext(t, lb + "i" + rb, bs + lb + "i" + rb + bs)
	t = replacetext(t, lb + "u" + rb, bs + lb + "u" + rb + bs)
	t = replacetext(t, lb + "field" + rb, bs + lb + "field" + rb + bs)
	t = replacetext(t, lb + "signfield" + rb, bs + lb + "signfield" + rb + bs)
	t = replacetext(t, lb + "date" + rb, bs + lb + "date" + rb + bs)
	t = replacetext(t, lb + "time" + rb, bs + lb + "time" + rb + bs)
	t = replacetext(t, lb + "br" + rb, bs + lb + "br" + rb + bs)
	t = replacetext(t, lb + "hr" + rb, bs + lb + "hr" + rb + bs)
	t = replacetext(t, lb + "*" + rb, bs + lb + "*" + rb + bs)
	t = replacetext(t, lb + "row" + rb, bs + lb + "row" + rb + bs)
	t = replacetext(t, lb + "cell" + rb, bs + lb + "cell" + rb + bs)
	t = replacetext(t, lb + "logo" + rb, bs + lb + "logo" + rb + bs)
	return t
