/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		".50 Kurtz, Speed Loader",
			list(name="Speed Loader (.50)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50),
			...
			list(name="Speed Loader (.50 Pepperball)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/rubber/pepperball),
			list(name="Speed Loader (.50 Practice)", cost=20, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/practice),
		".50 Kurtz, Heavy Pistol",
			list(name="Heavy Pistol Magazine (.50 Standard)", cost=100, path=/obj/item/ammo_magazine/kurtz_50),
			list(name="Heavy Pistol Magazine (.50 High-Velocity)", cost=150, path=/obj/item/ammo_magazine/kurtz_50/hv),
			...
			list(name="Heavy Pistol Magazine (.50 Pepperball)", cost=100, path=/obj/item/ammo_magazine/kurtz_50/rubber/pepperball),
		...
		".50 Kurtz, Ammo Boxes",
			...
			list(name="Box (.50 High-Velocity)", cost=480, path=/obj/item/ammo_magazine/ammobox/kurtz_50/hv),
			...
			list(name="Box (.50 Pepperball)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50/rubber/pepperball),
