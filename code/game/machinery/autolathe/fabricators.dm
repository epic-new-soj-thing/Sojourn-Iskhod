/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		"9mm Speed Loader",
			list(name="Speed Loader (9mm)", cost=30, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm),
			list(name="Speed Loader (9mm High Velocity)", cost=50, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm/hv),
			list(name="Speed Loader (9mm Hollow Point)", cost=30, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm/lethal),
			list(name="Speed Loader (9mm Rubber)", cost=30, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm/rubber),
			list(name="Speed Loader (9mm Pepperball)", cost=30, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm/rubber/pepperball),
			list(name="Speed Loader (9mm Practice)", cost=10, path=/obj/item/ammo_magazine/speed_loader_pistol_9mm/practice),
		"9mm Standard",
			list(name="Standard Magazine (9mm)", cost=50, path=/obj/item/ammo_magazine/pistol_9mm),
			list(name="Standard Magazine (9mm High Velocity)", cost=80, path=/obj/item/ammo_magazine/pistol_9mm/highvelocity),
			list(name="Standard Magazine (9mm Hollow Point)", cost=50, path=/obj/item/ammo_magazine/pistol_9mm/lethal),
			list(name="Standard Magazine (9mm Rubber)", cost=50, path= /obj/item/ammo_magazine/pistol_9mm/rubber),
			list(name="Standard Magazine (9mm Pepperball)", cost=50, path= /obj/item/ammo_magazine/pistol_9mm/rubber/pepperball),
			list(name="Standard Magazine (9mm Practice)", cost=50, path=/obj/item/ammo_magazine/pistol_9mm/practice),
		"9mm High Capacity",
			list(name="High Capacity Magazine (9mm)", cost=100, path=/obj/item/ammo_magazine/highcap_pistol_9mm),
			list(name="High Capacity Magazine (9mm High Velocity)", cost=150, path=/obj/item/ammo_magazine/highcap_pistol_9mm/highvelocity),
			list(name="High Capacity Magazine (9mm Hollow Point)", cost=100, path=/obj/item/ammo_magazine/highcap_pistol_9mm/lethal),
			list(name="High Capacity Magazine (9mm Rubber)", cost=100, path=/obj/item/ammo_magazine/highcap_pistol_9mm/rubber),
			list(name="High Capacity Magazine (9mm Pepperball)", cost=100, path=/obj/item/ammo_magazine/highcap_pistol_9mm/rubber/pepperball),
			list(name="High Capacity Magazine (9mm Practice)", cost=20, path=/obj/item/ammo_magazine/highcap_pistol_9mm/practice),
		"9mm SMG",
		...
		"9mm Drum",
			list(name="Standard Drum (9mm)", cost=375, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum),
			list(name="Standard Drum (9mm High Velocity)", cost=460, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum/hv),
			list(name="Standard Drum (9mm Hollow Point)", cost=375, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum/lethal),
			list(name="Standard Drum (9mm Rubber)", cost=375, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum/rubber),
			list(name="Standard Drum (9mm Pepperball)", cost=375, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum/rubber/pepperball),
			list(name="Standard Drum (9mm Empty)", cost=200, path=/obj/item/ammo_magazine/highcap_pistol_9mm/drum/empty),
		"9mm Ammo Boxes",
			list(name="Packet (9mm Auto)", cost=165, path=/obj/item/ammo_magazine/ammobox/pistol_9mm),
			list(name="Packet (9mm Auto High Velocity)", cost=270, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/hv),
			list(name="Packet (9mm Auto Hollow Point)", cost=165, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/lethal),
			list(name="Packet (9mm Auto Rubber)", cost=165, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/rubber),
			list(name="Packet (9mm Auto Pepperball)", cost=165, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/rubber/pepperball),
			list(name="Packet (9mm Auto Practice)", cost=100, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/practice),
			list(name="Box    (9mm auto)", cost=1155, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/large),
			list(name="Box    (9mm auto High Velocity)", cost=1955, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/large/hv),
			list(name="Box    (9mm auto Hollow Point)", cost=1155, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/large/lethal),
			list(name="Box    (9mm auto Rubber)", cost=1155, path=/obj/item/ammo_magazine/ammobox/pistol_9mm/large/rubber),
		"10mm Magnum, Speed Loader",
			list(name="Speed Loader (10mm)", cost=45, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm),
			list(name="Speed Loader (10mm High velocity)", cost=80, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm/highvelocity),
			list(name="Speed Loader (10mm Hollow point)", cost=45, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm/lethal),
			list(name="Speed Loader (10mm Rubber)", cost=45, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm/rubber),
			list(name="Speed Loader (10mm Pepperball)", cost=45, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm/rubber/pepperball),
			list(name="Speed Loader (10mm Practice)", cost=25, path=/obj/item/ammo_magazine/speed_loader_pistol_10mm/practice),
		"10mm Magnum, Pistol",
			list(name="Magnum Magazine (10mm Magnum)", cost=75, path=/obj/item/ammo_magazine/pistol_10mm),
			list(name="Magnum Magazine (10mm Magnum High Velocity)", cost=130, path=/obj/item/ammo_magazine/pistol_10mm/hv),
			list(name="Magnum Magazine (10mm Magnum Hollow Point)", cost=75, path=/obj/item/ammo_magazine/pistol_10mm/lethal),
			list(name="Magnum Magazine (10mm Magnum Rubber)", cost=75, path=/obj/item/ammo_magazine/pistol_10mm/rubber),
			list(name="Magnum Magazine (10mm Magnum Pepperball)", cost=75, path=/obj/item/ammo_magazine/pistol_10mm/rubber/pepperball),
			list(name="Magnum Magazine (10mm Magnum Practice)", cost=30, path=/obj/item/ammo_magazine/pistol_10mm/practice),
		"10mm Magnum, SMG",
			list(name="SMG Magazine (10mm Magnum)", cost=480, path= /obj/item/ammo_magazine/smg_10mm),
			list(name="SMG Magazine (10mm Magnum High Velocity)", cost=750, path= /obj/item/ammo_magazine/smg_10mm/hv),
			list(name="SMG Magazine (10mm Magnum Hollow Point)", cost=480, path= /obj/item/ammo_magazine/smg_10mm/lethal),
			list(name="SMG Magazine (10mm Magnum Rubber)", cost=400, path= /obj/item/ammo_magazine/smg_10mm/rubber),
			list(name="SMG Magazine (10mm Magnum Pepperball)", cost=400, path= /obj/item/ammo_magazine/smg_10mm/rubber/pepperball),
			list(name="SMG Magazine (10mm Magnum Practice)", cost=300, path= /obj/item/ammo_magazine/smg_10mm/practice),
			list(name="SMG Magazine (10mm Magnum Empty)", cost=240, path= /obj/item/ammo_magazine/smg_10mm/empty),
		"10mm Ammo Boxes",
			list(name="Packet (10mm Magnum)", cost=250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm),
			list(name="Packet (10mm Magnum High Velocity)", cost=460, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/hv),
			list(name="Packet (10mm Magnum Hollow Point)", cost=250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/lethal),
			list(name="Packet (10mm Magnum Rubber)", cost=250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/rubber),
			list(name="Packet (10mm Magnum Pepperball)", cost=250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/rubber/pepperball),
			list(name="Packet (10mm Magnum Practice)", cost=100, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/practice),
			list(name="Box    (10mm Magnum)", cost=1250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/large),
			list(name="Box    (10mm Magnum High Velocity)", cost=1920, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/large/hv),
			list(name="Box    (10mm Magnum Hollow Point)", cost=1250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/large/lethal),
			list(name="Box    (10mm Magnum Rubber)", cost=1250, path=/obj/item/ammo_magazine/ammobox/pistol_10mm/large/rubber),
		"12mm, Speed Loader",
			list(name="Speed Loader (12mm)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_12),
			list(name="Speed Loader (12mm High Velocity)", cost=100, path=/obj/item/ammo_magazine/speed_loader_kurtz_12/highvelocity),
			list(name="Speed Loader (12mm Hollow Point)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_12/lethal),
			list(name="Speed Loader (12mm Rubber)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_12/rubber),
			list(name="Speed Loader (12mm Pepperball)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_12/rubber/pepperball),
			list(name="Speed Loader (12mm Practice)", cost=20, path=/obj/item/ammo_magazine/speed_loader_kurtz_12/practice),
		"12mm, Heavy Pistol",
			list(name="Heavy Pistol Magazine (12mm Standard)", cost=100, path=/obj/item/ammo_magazine/kurtz_12),
			list(name="Heavy Pistol Magazine (12mm High velocity)", cost=150, path=/obj/item/ammo_magazine/kurtz_12/hv),
			list(name="Heavy Pistol Magazine (12mm Hollow point)", cost=100, path=/obj/item/ammo_magazine/kurtz_12/lethal),
			list(name="Heavy Pistol Magazine (12mm Rubber)", cost=100, path=/obj/item/ammo_magazine/kurtz_12/rubber),
			list(name="Heavy Pistol Magazine (12mm Pepperball)", cost=100, path=/obj/item/ammo_magazine/kurtz_12/rubber/pepperball),
			list(name="Heavy Pistol Magazine (12mm Practice)", cost=20, path=/obj/item/ammo_magazine/kurtz_12/practice),
		"12mm, Ammo Boxes",
			list(name="Box (12mm Standard)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_12),
			list(name="Box (12mm High Velocity)", cost=480, path=/obj/item/ammo_magazine/ammobox/kurtz_12/hv),
			list(name="Box (12mm Hollow Point)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_12/lethal),
			list(name="Box (12mm Rubber)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_12/rubber),
			list(name="Box (12mm Pepperball)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_12/rubber/pepperball),
			list(name="Box (12mm Practice)", cost=100, path=/obj/item/ammo_magazine/ammobox/kurtz_12/practice),
		"10x24 Caseless",
		...
		"20mm Shotgun shells, magazines",
			...
			list(name="Ammo Drum (20mm Sabot Slug)", cost=850, path=/obj/item/ammo_magazine/drum_20),
			list(name="Ammo Drum (20mm Buckshot)", cost=850, path=/obj/item/ammo_magazine/drum_20/pellet),
			list(name="Ammo Drum (20mm Beanbag)", cost=650, path=/obj/item/ammo_magazine/drum_20/beanbag),
			list(name="Ammo Drum (20mm Empty)", cost=500, path=/obj/item/ammo_magazine/drum_20/empty),
		"20mm Shotgun, Boxes",
